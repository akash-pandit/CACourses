...
A series of scripts that process a local copy of ASSIST.org's articulations into a PostgreSQL database. Currently, this is 3,314 nested JSON files summing up to ~2.7 Gigabytes of data. 
